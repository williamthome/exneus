...
Exneus is licensed under the [Apache License Version 2.0](LICENSE.md), for all code.

## Reporting a bug

Exneus is not perfect software and will be buggy.

Bugs can be reported via
[GitHub issues: bug report](https://github.com/williamthome/exneus/issues/new?template=bug_report.md).

Some contributors and maintainers may be unpaid developers working on Exneus, in their own time,
...
- search, in existing [issues](https://github.com/williamthome/exneus/issues) (open or closed),
...
[GitHub issues: feature request](https://github.com/williamthome/exneus/issues/new?template=feature_request.md).

We may discuss details with you regarding the implementation, and its inclusion within the project.

We try to have as many of Exneus's features tested as possible. Everything that a user can do,
...
All fixes to Exneus end up requiring a +1 from one or more of the project's maintainers.
...
Exneus has been improved by
[many contributors](https://github.com/williamthome/exneus/graphs/contributors)!
